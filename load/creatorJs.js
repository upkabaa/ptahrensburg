...
function edInsertImage(which){myField=document.getElementById(which);var myValue=prompt('Enter the URL of the image','http://');if(myValue){myValue='<img width="302" src="'
+ myValue
...
function update()
{
  ...
  if (old != textarea.value)
  {
    old = textarea.value;
    d.open();
    d.write('<link rel="stylesheet" href="load/stile.css" type="text/css" media="screen">' + old);
    d.close();
  }
